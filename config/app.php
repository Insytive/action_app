...
return [
     ...
     */
    'debug' => (isset($_GET['debug']) && 'active' === $_GET['debug']) ? true :  filter_var(env('DEBUG', false), FILTER_VALIDATE_BOOLEAN),
    ...
    'EmailTransport' => [
        'actionsaorgza' => [
            'host' => 'mail.actionsa.org.za',
            'port' => 25,
            'timeout' => 30,
            'username' => 'donotreply@actionsa.org.za',
            'password' => 'Int3rn3t15!',
            'className' => 'Smtp',
            'tls' => true,
            'context' => [
	...
	'default' => [
            ...
            'port' => 587,
            'timeout' => 30,
            'username' => 'actionsouthafrica@gmail.com',
            'password' => 'ASApp2020!',
            'className' => 'Smtp',
            'tls' => true,
            'context' => [
    ...
    'Email' => [
        'default' => [
            'transport' => 'default',
	    'from' => ['donotreply@actionsa.org.za' => 'ActionSA'],
	    'log' => true,
            /*
