    ...
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-header d-flex align-items-center border-0">
                <h3 class="w-75 float-left card-title m-0"><?= __('Edit Area') ?></h3>
                <div class="dropdown dropleft text-right w-25 float-right">
                    ...
                    <div class="dropdown-menu" aria-labelledby="asaCtrlOpts">
                            ...
                            ['confirm' => __('Are you sure you want to delete # {0}?', $area->id), 'class' => 'dropdown-item text-mute']
                            ) ?>
                        <?= $this->Html->link(__('List Areas'), ['action' => 'index'], ['class' => 'dropdown-item']) ?>
                    </div>
                </div>
            </div>
