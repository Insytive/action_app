...
$this->assign('title', __('Edit Voting Station'));
?>
<div class="row">
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-header d-flex align-items-center border-0">
                <h3 class="w-75 float-left card-title m-0"><?= __('Edit Voting Station') ?></h3>
                <div class="dropdown dropleft text-right w-25 float-right">
                    ...
                    <div class="dropdown-menu" aria-labelledby="asaCtrlOpts">
                            <?= $this->Form->postLink(
                            __('Delete'),
                            ['action' => 'delete', $votingStation->id],
                            ['confirm' => __('Are you sure you want to delete # {0}?', $votingStation->id), 'class' => 'dropdown-item text-mute']
                            ) ?>
                        <?= $this->Html->link(__('List Voting Stations'), ['action' => 'index'], ['class' => 'dropdown-item']) ?>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="votingStations form content">
                <?php
